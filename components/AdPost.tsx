...
export default function AdPost({ user, post, displayAnswerTo }: { user: Profile | null; post: ExtendedPost, displayAnswerTo?: boolean }) {
    ...
    return (
        ...
        >
            ...
            <div className="flex gap-2">
                <Image
                    src={"https://logowik.com/content/uploads/images/minecraft5608.jpg"}
                ...
                <div className="postRedirect flex items-center justify-between w-full">
                    <div className="flex items-center gap-1">
                        ...
                        Minecraft <span className="ml-4 bg-orange-500/50 text-gray-200 rounded-md px-2 py-1 text-xs font-semibold">Sponsorisé</span>
                    </div>
                    <Popover
                        placement="top"
                        offset={10}
            ...
            <div className="postRedirect flex flex-col px-10 gap-2">
                <div className='postRedirect'>
                    ...
                    <div className="postRedirect text-textDark dark:text-textLight working-break-words transition-all !duration-[125ms] font-light mb-4 flex flex-col gap-4">
                        <span>Your world. Your rules.</span>

                        <span>Create, explore, and survive in the infinite world of Minecraft. Build anything you can imagine, from cozy cottages to epic castles. Delve into unexplored lands, encounter unique creatures, and uncover hidden treasures.
                            Minecraft: Where Imagination Meets Adventure</span>

                        <span>Play Now: https://www.minecraft.net/</span>
                    </div>
                    <div
