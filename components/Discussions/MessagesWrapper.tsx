        ...
        <div className={`flex-col w-full sm:w-9/12 h-full overflow-hidden `}>
            ...
            <div className='flex sm:flex-col bg-bgDark items-center justify-center w-full h-[50px] sm:h-[100px] gap-2 relative z-[10]'>
                ...
                <Avatar as={Link}
                    ...
                    className={`w-8 h-8 sm:h-12 sm:w-12 aspect-square rounded-full ${selectedCDiscussion.is_group ? 'invert p-1' : ''} ${selectedCDiscussion.is_group && profileConnected.id_user === selectedCDiscussion.created_by ? "cursor-pointer" : "cursor-default"}`} />
