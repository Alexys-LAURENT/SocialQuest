...
import SearchBarMobileSection from './SearchBarMobileSection';
...
const NavBar = ({ user }: { user: Profile | null }) => {
  ...
  return activePath !== '/login' && activePath !== '/resetPassword' ? (
    <>
      <Navbar
        maxWidth="2xl"
        className="py-2 bg-bgLight dark:bg-tempBgDark transition-all !duration-500"
        position="sticky"
      ...
      >
        <NavbarContent justify="start">
          ...
          <NavbarItem>
            <MagnifyingGlassIcon
              ...
              className="flex sm:hidden w-6 h-6 text-textDark dark:text-textLight"
            />
          </NavbarItem>
        </NavbarContent>
        ...
        <NavbarContent justify="end">
          ...
          <NavbarItem className="hidden md:flex">
            <Link href="/shop" aria-label="Boutique">
          ...
          {user ? (
            <>
              ...
              <NavbarItem>
                <Link href={`/messages`} className="items-center">
            ...
            <NavbarItem>
              <Button
                ...
                href="/login"
                variant="flat"
                className="customButton bg-secondary/70 border-secondary text-textLight"
              >
                Connexion
              </Button>
            </NavbarItem>
      ...
      {showNavBarMobile && <SearchBarMobileSection setShowNavBarMobile={setShowNavBarMobile} />}
    </>
  ) : (
    <></>
  );
