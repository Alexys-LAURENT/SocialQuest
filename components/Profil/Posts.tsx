...
import { HeartIcon, ChatBubbleLeftIcon, EllipsisVerticalIcon, ShareIcon, TrashIcon } from '@heroicons/react/24/outline'
            ...
            <div className="flex flex-col border border-gray-500 rounded-md p-2 gap-2">
                ...
                <div className="flex flex-col px-10 gap-2">
                    ...
                    <div className="flex gap-4">
                        <Button variant='flat' color='primary' className='min-w-0 h-7 w-max rounded-sm text-white px-2'>
