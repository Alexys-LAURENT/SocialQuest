...
const ProfilPicture = ({ isUserProfil }: { isUserProfil: boolean }) => {
    ...
    return (
        <Upload
            ...
            className="ms:ms-9 z-50 !min-h-[112px] !min-w-[112px] !max-h-[112px] !max-w-[112px] md:!min-h-[160px] md:!min-w-[160px] md:!max-h-[160px] md:!max-w-[160px] transition-all text-textLight opacity-0 hover:opacity-100"
