    ...
    <>
      {user ? (
        guilde!.isUserInGuilde ? (
          <Button className="customButton bg-danger/70 border-danger" onClick={() => handleLeaveGuild()} color="danger">
            Quitter
          </Button>
        ) : (
          <Button className="customButton bg-tempDarkBorder/70 border-tempDarkBorder" onClick={() => handleJoinGuild()}>
            Rejoindre
          </Button>
        )
      ) : (
        <Button
          className="customButton bg-tempDarkBorder/70 border-tempDarkBorder"
          as={Link}
          href="/login"
          color="default"
        >
